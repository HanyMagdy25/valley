      ...
      <div className="container m-auto px-6">
        <div className="grid w-full grid-cols-9 gap-7 md:gap-12">
          <div className="col-span-9 md:col-span-3 flex flex-col ">
            <div className="px-14 py-7 text-center shadow-custom rounded-md flex flex-col items-center">
          ...
          <div className="col-span-9 md:col-span-3 flex flex-col ">
            <div className="px-12 py-7 text-center shadow-custom rounded-md flex flex-col items-center">
