  ...
  return (
    <div className="bg-secondColor w-full py-10">
      <div className="container m-auto px-6">
        <h2 className="text-3xl font-semibold opacity-90 mb-10">
          نضمن لك
        </h2>
        <div className="grid w-full grid-cols-9 gap-3 md:gap-12">
          <div className="col-span-9 md:col-span-3 flex flex-col ">
            <div className="mb-6 px-14 py-10 text-center shadow-custom rounded-md flex flex-col items-center">
